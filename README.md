...
* Focused on creating a scalable architecture that allows for the seamless integration of various mathematical models.

## Languages and Tools
| Category | Skills |
| :--- | :--- |
| Languages | Python, SQL, C++ (learning)  |
| Data Viz | Tableau, Excel (Financial Modeling) |
| Research | Nexis Uni, Interviewing, Statement Analysis |
